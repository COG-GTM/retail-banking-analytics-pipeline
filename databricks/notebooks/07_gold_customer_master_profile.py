...
from retail_banking.gold import customer_master_profile
...
print(f"gold plan: {cfg.fqn(cfg.gold_schema, 'customer_master_profile')}")
if cfg.dry_run:
    dbutils.notebook.exit("DRY_RUN")
if cfg.skip_gold:
    dbutils.notebook.exit("SKIPPED")
customer_master_profile.run(spark, cfg)
