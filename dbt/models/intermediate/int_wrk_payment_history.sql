...
-- monthly anniversary of OPEN_DATE. This anniversary arithmetic is expressed
-- with native Teradata ADD_MONTHS / MONTHS_BETWEEN (see README "Dialect notes").
-- The Teradata cast shorthand "expr (INTEGER)" is rewritten to cast(expr as integer).
